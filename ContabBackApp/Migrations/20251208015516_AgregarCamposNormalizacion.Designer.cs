...
namespace ContabBackApp.Migrations
{
    ...
    [Migration("20251208015516_AgregarCamposNormalizacion")]
    partial class AgregarCamposNormalizacion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ContabBackApp.Models.Cliente", b =>
                {
                    ...
                    b.HasIndex(new[] { "Rnc" }, "idx_clientes_rnc")
                        .IsUnique();

                    b.ToTable("clientes", (string)null);
                });

            modelBuilder.Entity("ContabBackApp.Models.ConfiguracionSistema", b =>
                {
            ...
            modelBuilder.Entity("ContabBackApp.Models.CuentasContable", b =>
                {
                    ...
                    b.HasIndex(new[] { "Codigo" }, "idx_cuentas_codigo")
                        .IsUnique();
            ...
            modelBuilder.Entity("ContabBackApp.Models.TiposDocumento", b =>
                {
                    ...
                    b.Property<string>("TipoMovimientoEsperado")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(2)
                        .HasColumnType("character(2)")
